...
public class FreeXs {
  Stream<IT.X> ftvE(E e){ return switch(e){
    ...
    case Literal l -> l.bs().stream().map(b->b.x());
  ...
  Stream<IT.X> ftvMs(List<M> ms){ return ms.stream().flatMap(this::ftvM); }//TODO: will have to be used to compute the inferred bs?
